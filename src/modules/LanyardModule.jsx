...
export default function Lanyard({ position = [0, 0, 30], gravity = [0, -40, 0], fov = 20, transparent = true }) {
    return (
        <div className="absolute mt-[7vh] ml-[30vw] w-[40vw] h-screen flex justify-center items-center transform origin-center overflow-hidden">  
            <Canvas
                className='transform translate-x-80'
