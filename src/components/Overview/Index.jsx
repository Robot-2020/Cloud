...
function Overview() {
  ...
  useEffect(() => {
    ...
    new hoverEffect({
      ...
      intensity: 0.8,
      imagesRatio: 360 / 320,
      image1: "https://diveintodream.oss-cn-shenzhen.aliyuncs.com/img/8.jpg",
      image2: "https://diveintodream.oss-cn-shenzhen.aliyuncs.com/img/7.jpg",
      displacementImage: 'https://diveintodream.oss-cn-shenzhen.aliyuncs.com/img/9.jpg',
      speedIn: 0.5,   // img
    ...
    new hoverEffect({
      ...
      intensity: 0.8,
      imagesRatio: 360 / 320,
      image1: "https://diveintodream.oss-cn-shenzhen.aliyuncs.com/img/4.JPG",
      image2: "https://diveintodream.oss-cn-shenzhen.aliyuncs.com/img/3.jpg",
      displacementImage: 'https://diveintodream.oss-cn-shenzhen.aliyuncs.com/img/9.jpg',
    ...
    new hoverEffect({
      ...
      intensity: 0.8,
      imagesRatio: 360 / 320,
      image1: "https://diveintodream.oss-cn-shenzhen.aliyuncs.com/img/6.JPG",
      image2: "https://diveintodream.oss-cn-shenzhen.aliyuncs.com/img/5.JPG",
      displacementImage: 'https://diveintodream.oss-cn-shenzhen.aliyuncs.com/img/9.jpg',
      speedIn: 0.5,   // 鼠标移入时的过渡时间（秒）
      speedOut: 0.5,  // 鼠标移出时的过渡时间（秒）
    })
  ...
  return (
    <div id="blog" className="page3 min-h-[120vh]">
      <div className="relative sm:flex gap-[5vw] w-full h-auto sm:px-[4vw]">
        <div className="w-full">
          {/* 标题部分 */}
          <div className="aboutHeading w-full flex flex-col justify-center items-center overflow-hidden space-y-[-1vh]">
            {/* 底部的大标题 */}
            <h1 className={`footText ${styles.footText} tracking-tighter text-[5vw] font-extrabold sm:tracking-normal uppercase`}>
              404 Sleep
            </h1>
            <div className='w-full flex flex-row justify-between'>
              ...
              <div className={`footText ${styles.footText} tracking-tighter text-[5vw] font-extrabold sm:tracking-normal uppercase`}>
                100% Learning
              </div>
      ...
      <div className="w-full relative flex justify-between items-start gap-2 pt-0 overflow-x-hidden">
        ...
        <div className="secondCol w-1/3 mt-[2vw] ml-[2vw] ">
          ...
          <div id="imageContainer" ref={wrapper1} className={`imageContainer ${styles.imageContainer} relative overflow-hidden sm:w-[18vw] sm:h-[20vw] sm:ml-0`}>
            <img src="https://diveintodream.oss-cn-shenzhen.aliyuncs.com/img/8.jpg" alt="image1"
        ...
        <div className="secondCol w-1/3 mt-[2vw] ">
          ...
          <div id="imageContainer" ref={wrapper2}
            className={`imageContainer ${styles.imageContainer} sm:ml-0 sm:w-[18vw] sm:h-[20vw] relative overflow-hidden`}>
            <img src="https://diveintodream.oss-cn-shenzhen.aliyuncs.com/img/4.JPG" alt="image1"
        ...
        <div className="thirdThirdCol w-1/3 mt-[2vw]">
          ...
          <div id="imageContainer" ref={wrapper3}
            className={`imageContainer ${styles.imageContainer} sm:ml-0 realtive w-[18vw] h-[20vw] relative overflow-hidden `}
          >
            <img src="https://diveintodream.oss-cn-shenzhen.aliyuncs.com/img/6.JPG" alt="image1"
              className="inline-block sm:hidden w-full h-full object-cover"
            />
          </div>
